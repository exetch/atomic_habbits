...
class HabitListCreateView(generics.ListCreateAPIView):
    """
        ...
        и создания новой привычки. Только аутентифицированные пользователи имеют доступ к этому представлению.
...
class PublicHabitListView(generics.ListAPIView):
    """
        ...
        Это представление предоставляет API для получения списка привычек, отмеченных как публичные.
        Доступно для всех аутентифицированных пользователей. Используется пагинация для управления объемом данных.
